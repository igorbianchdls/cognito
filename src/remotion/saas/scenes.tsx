...
import { clampProgress, fadeSlide, stagger } from '@/remotion/saas/animation'
import { BrowserWindowMock, ChatAssistantMock, CommandPaletteMock, DashboardMock, KanbanMock, TableMock } from '@/remotion/saas/productMockups'
import { FeatureCard, FloatingPanel, MetricCard, SaaSSceneShell, SceneCopy } from '@/remotion/saas/primitives'
import type {
  SaaSBrand,
  SaaSHeroScene,
