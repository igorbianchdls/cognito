...
const DEFAULT_UI: FinanceiroDashboardUIState = {
  fonts: {
    ...
    kpiTitle: { family: 'Space Mono', weight: 500, letterSpacing: 0, color: '#adadad', size: 13, transform: 'uppercase' },
    chartTitle: { family: 'Space Mono', weight: 500, letterSpacing: 0, color: '#adadad', size: 13, transform: 'uppercase' },
    ...
    headerTitle: { family: 'Space Mono', weight: 700, letterSpacing: 0, color: '#111827', size: 20, transform: 'uppercase' },
    headerSubtitle: { family: 'Inter', weight: 400, letterSpacing: 0, color: '#6b7280', size: 12, transform: 'none' },
