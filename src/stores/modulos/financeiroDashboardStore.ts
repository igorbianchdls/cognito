...
const DEFAULT_UI: FinanceiroDashboardUIState = {
  fonts: {
    ...
    headerSubtitle: { family: 'Barlow', weight: 400, letterSpacing: -0.03, color: 'rgb(168, 168, 168)', size: 16, transform: 'none' },
    sidebarSectionTitle: { family: 'Space Mono', weight: 500, letterSpacing: 0, color: '#808080', size: 12, transform: 'uppercase' },
    sidebarItemText: { family: 'Barlow', weight: 400, letterSpacing: -0.03, color: 'rgb(64, 64, 64)', size: 15, transform: 'none' },
  },
...
const DEFAULT_FILTERS: FinanceiroDashboardFiltersState = {
  dateRange: { from: '2025-12-15', to: '2025-12-30' },
  dataFilter: 'todos',
}
