...
export const initialLiquidGrid = `<dashboard render="html" theme="branco">
  ...
  <div class="vb-container">
    ...
    <section class="row kpis" data-role="section" style="display:flex; gap:16px; margin-bottom:16px;">
    ...
    <section class="row charts" data-role="section" style="display:flex; gap:16px; margin-bottom:16px;">
      <article class="card">
...
export const visualBuilderActions = {
  ...
  <div class="vb-container">
    <section class="row kpis" data-role="section">
    ...
    <section class="row charts" data-role="section">
