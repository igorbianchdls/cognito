...
export const initialLiquidGrid = `<dashboard render="html" theme="branco" style="border:1px solid red;">
  ...
  <div class="vb-container" style="padding: 0; border: 0px;">
...
// Legacy sample (migrated to new HTML + <Chart> + <query> format)
// Kept for backwards-compatibility references; mirrors the default template.
export const initialDsl = initialLiquidGrid
