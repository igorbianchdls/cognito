...
export const initialDsl = `<dashboard theme="branco" title="Dashboard de Vendas" subtitle="Análise de desempenho comercial" layout-mode="grid-per-row">
  ...
  <row id="9" cols-d="2" cols-t="2" cols-m="1" gap-x="16" gap-y="16">
    <widget id="insights_card_2" type="insights2" order="1" span-d="1" span-t="1" span-m="1" height="240" title="Insights">
      <config>
        {"insights2Config":{
          "title":"Insights",
          "items":[
    ...
    <widget id="insights_card_3" type="insights2" order="2" span-d="1" span-t="1" span-m="1" height="240" title="Insights Extras">
      <config>
        {"insights2Config":{
