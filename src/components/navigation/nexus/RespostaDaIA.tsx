...
import DatasetsList from '@/components/tools/DatasetsList';
import TablesList from '@/components/tools/TablesList';
import TableSchema from '@/components/tools/TableSchema';
import CampaignsList from '@/components/tools/CampaignsList';
import TableData from '@/components/tools/TableData';
...
import InsightsResults from '@/components/tools/InsightsResults';
import AlertsResults from '@/components/tools/AlertsResults';
import RecommendationsResults from '@/components/tools/RecommendationsResults';
import ReportResults from '@/components/tools/ReportResults';
import TableCreation from '@/components/tools/TableCreation';
import { KPICard } from '@/components/widgets/KPICard';
import WebPreviewCard from '@/components/tools/WebPreviewCard';
import PlanAnalysis from '@/components/tools/PlanAnalysis';
import PlanAnalysisStreaming from '@/components/tools/PlanAnalysisStreaming';
import TimelineContext from '@/components/tools/TimelineContext';
...
import ContentCreationSuccess from '@/components/tools/ContentCreationSuccess';
import SalesCallsList from '@/components/tools/SalesCallsList';
import RHCandidatesList from '@/components/tools/RHCandidatesList';
import ServiceOrdersList from '@/components/tools/ServiceOrdersList';
import { type ContaReceberRow } from '@/components/tools/ContasAReceberTable';
import ReceiptsList from '@/components/tools/ReceiptsList';
import NotasFiscaisList from '@/components/tools/NotasFiscaisList';
import InventoryList from '@/components/tools/InventoryList';
import type { FluxoCaixaRow } from '@/components/tools/FluxoCaixaResult';
import GenericResultTable from '@/components/tools/GenericResultTable';
import RankingPorDimensaoFinanceiroResult from '@/components/tools/RankingPorDimensaoFinanceiroResult';
import AgingFinanceiroResult from '@/components/tools/AgingFinanceiroResult';
...
import AnaliseDeCampanhas from '@/components/tools/paid-traffic/analiseDeCampanhas';
import OrganicMarketingDataTable from '@/components/tools/OrganicMarketingDataTable';
import PaidTrafficDataTable from '@/components/tools/PaidTrafficDataTable';
import OrdensDeServicoResult from '@/components/tools/servicos/OrdensDeServicoResult';
import TecnicosResult from '@/components/tools/servicos/TecnicosResult';
import AgendamentosResult from '@/components/tools/servicos/AgendamentosResult';
import CatalogoServicosResult from '@/components/tools/servicos/CatalogoServicosResult';
import HistoricoClienteResult from '@/components/tools/servicos/HistoricoClienteResult';
import IndicadoresServicosResult from '@/components/tools/servicos/IndicadoresServicosResult';
...
import FornecedoresCompraResult from '@/components/tools/compras/FornecedoresCompraResult';
import PedidosCompraResult from '@/components/tools/compras/PedidosCompraResult';
import RecebimentosCompraResult from '@/components/tools/compras/RecebimentosCompraResult';
import SolicitacoesCompraResult from '@/components/tools/compras/SolicitacoesCompraResult';
import CotacoesCompraResult from '@/components/tools/compras/CotacoesCompraResult';
import KpisComprasResult from '@/components/tools/compras/KpisComprasResult';
import PedidosVendasResult from '@/components/tools/vendas-b2b/PedidosVendasResult';
import PivotWrapper from '@/components/tools/vendas-analytics/PivotWrapper';
...
import ClientesVendasResult from '@/components/tools/vendas-b2b/ClientesVendasResult';
import TerritoriosVendasResult from '@/components/tools/vendas-b2b/TerritoriosVendasResult';
import EquipesVendasResult from '@/components/tools/vendas-b2b/EquipesVendasResult';
import CanaisVendasResult from '@/components/tools/vendas-b2b/CanaisVendasResult';
import KpisVendasResult from '@/components/tools/vendas-b2b/KpisVendasResult';
import InventoryDataTable from '@/components/tools/InventoryDataTable';
import TopProdutosReceitaLiquidaTable, { type TopProdutosRow } from '@/components/tools/TopProdutosReceitaLiquidaTable';
import DesempenhoVendasMensalResult, { type DesempenhoVendasMensalRow } from '@/components/tools/ecommerce/DesempenhoVendasMensalResult';
import AnalisePerformanceCategoriaResult, { type AnalisePerformanceCategoriaRow } from '@/components/tools/ecommerce/AnalisePerformanceCategoriaResult';
...
import CestaComprasResult, { type CestaComprasRow } from '@/components/tools/ecommerce/CestaComprasResult';
import VendasPorEstadoResult, { type VendasPorEstadoRow } from '@/components/tools/ecommerce/VendasPorEstadoResult';
import LogisticsDataTable from '@/components/tools/LogisticsDataTable';
import ComprasDataTable from '@/components/tools/ComprasDataTable';
import ProjetosDataTable from '@/components/tools/ProjetosDataTable';
import RevenueMetricsResult, { type RevenueMetricsRow } from '@/components/tools/RevenueMetricsResult';
import CustomerMetricsResult from '@/components/tools/CustomerMetricsResult';
import ProductPerformanceResult from '@/components/tools/ProductPerformanceResult';
import CouponEffectivenessResult from '@/components/tools/CouponEffectivenessResult';
import ChannelAnalysisResult from '@/components/tools/ChannelAnalysisResult';
import DeliveryPerformanceResult from '@/components/tools/logistics/DeliveryPerformanceResult';
import CarrierBenchmarkResult from '@/components/tools/logistics/CarrierBenchmarkResult';
import ShippingCostStructureResult from '@/components/tools/logistics/ShippingCostStructureResult';
import ReverseLogisticsTrendsResult from '@/components/tools/logistics/ReverseLogisticsTrendsResult';
import OptimizePackageDimensionsResult from '@/components/tools/logistics/OptimizePackageDimensionsResult';
import DetectDeliveryAnomaliesResult from '@/components/tools/logistics/DetectDeliveryAnomaliesResult';
import ForecastDeliveryCostsResult from '@/components/tools/logistics/ForecastDeliveryCostsResult';
import DesempenhoEntregasGeralResult from '@/components/tools/logistics/DesempenhoEntregasGeralResult';
import EficienciaPorStatusResult from '@/components/tools/logistics/EficienciaPorStatusResult';
import EficienciaOperacionalPorCDResult from '@/components/tools/logistics/EficienciaOperacionalPorCDResult';
import PerfilPacotesPorTransportadoraResult from '@/components/tools/logistics/PerfilPacotesPorTransportadoraResult';
import AtrasosCriticosDeteccaoAnomaliasResult from '@/components/tools/logistics/AtrasosCriticosDeteccaoAnomaliasResult';
import LogisticaReversaDevolucoesResult from '@/components/tools/logistics/LogisticaReversaDevolucoesResult';
import RankingEficienciaPorCentroResult from '@/components/tools/logistics/RankingEficienciaPorCentroResult';
import AccountPerformanceResult from '@/components/tools/organic-marketing/AccountPerformanceResult';
import PlatformPerformanceResult from '@/components/tools/organic-marketing/PlatformPerformanceResult';
import PostFormatPerformanceResult from '@/components/tools/organic-marketing/PostFormatPerformanceResult';
import PublicationRankingResult from '@/components/tools/organic-marketing/PublicationRankingResult';
import EngagementByDayHourResult from '@/components/tools/organic-marketing/EngagementByDayHourResult';
import OrganicAnomaliesResult from '@/components/tools/organic-marketing/OrganicAnomaliesResult';
import SuddenReachDropResult from '@/components/tools/organic-marketing/SuddenReachDropResult';
import DesempenhoGeralDoSiteResult from '@/components/tools/web-analytics/DesempenhoGeralDoSiteResult';
import DesempenhoPorCanalResult from '@/components/tools/web-analytics/DesempenhoPorCanalResult';
import EtapasDoFunilGeralResult from '@/components/tools/web-analytics/EtapasDoFunilGeralResult';
import ContribuicaoPorPaginaResult from '@/components/tools/web-analytics/ContribuicaoPorPaginaResult';
import DesempenhoMobileVsDesktopResult from '@/components/tools/web-analytics/DesempenhoMobileVsDesktopResult';
import DeteccaoOutlierPorCanalResult from '@/components/tools/web-analytics/DeteccaoOutlierPorCanalResult';
import VisitantesRecorrentesResult from '@/components/tools/web-analytics/VisitantesRecorrentesResult';
import DesempenhoPorDiaHoraResult from '@/components/tools/web-analytics/DesempenhoPorDiaHoraResult';
import LtvMedioResult from '@/components/tools/web-analytics/LtvMedioResult';
import CampaignROASResult from '@/components/tools/paid-traffic/CampaignROASResult';
import AdsPlatformsResult from '@/components/tools/paid-traffic/AdsPlatformsResult';
import CreativeAdsPerformanceResult from '@/components/tools/paid-traffic/CreativeAdsPerformanceResult';
import DesempenhoPorGrupoDeAnuncioResult from '@/components/tools/paid-traffic/DesempenhoPorGrupoDeAnuncioResult';
import DesempenhoPorDiaDaSemanaResult from '@/components/tools/paid-traffic/DesempenhoPorDiaDaSemanaResult';
import DeteccaoAnomaliasROASResult from '@/components/tools/paid-traffic/DeteccaoAnomaliasROASResult';
...
import BalanceTAccountView from '@/products/erp/frontend/components/contabilidade/BalanceTAccountView';
...
import ContaPagarCriadaResult from '@/components/tools/workflow/ContaPagarCriadaResult';
import BuscarClienteResult from '@/components/tools/workflow/BuscarClienteResult';
import CriarClienteResult from '@/components/tools/workflow/CriarClienteResult';
import ContaReceberCriadaResult from '@/components/tools/workflow/ContaReceberCriadaResult';
import BuscarContaReceberResult from '@/components/tools/workflow/BuscarContaReceberResult';
import PagamentoRecebidoCriadoResult from '@/components/tools/workflow/PagamentoRecebidoCriadoResult';
import FinanceiroLookupsResult from '@/components/tools/workflow/FinanceiroLookupsResult';
import BuscarContaPagarResult from '@/components/tools/workflow/BuscarContaPagarResult';
import PagamentoEfetuadoCriadoResult from '@/components/tools/workflow/PagamentoEfetuadoCriadoResult';
import ExtratoProcessadoResult from '@/components/tools/workflow/ExtratoProcessadoResult';
import ExtratoBancarioCriadoResult from '@/components/tools/workflow/ExtratoBancarioCriadoResult';
import LancamentosFinanceirosResult from '@/components/tools/workflow/LancamentosFinanceirosResult';
import ConciliacaoRealizadaResult from '@/components/tools/workflow/ConciliacaoRealizadaResult';
