...
import { isImageWidget, isNavigationWidget } from '@/types/apps/droppedWidget'
import type { ImageConfig, NavigationConfig, ContainerConfig } from '@/types/apps/droppedWidget'
