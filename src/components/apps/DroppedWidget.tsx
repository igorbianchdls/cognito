...
import BarChartWrapper from './widgets/components/BarChartWrapper'
import LineChartWidget from './widgets/components/LineChartWidget'
...
export default function DroppedWidget({ widget, onRemove, onEdit, isSelected = false, onClick }: DroppedWidgetProps) {
  ...
  const renderWidget = () => {
    switch (widget.type) {
      ...
      case 'chart-bar':
        return <BarChartWrapper widget={widget} />
      case 'chart-line':
