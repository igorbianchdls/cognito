          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  console.log('📈 LineChartEditor: Primary color changed to:', e.target.value)
              ...
              <div className="flex gap-2">
                {[
                  ...
                  <button
                    key={palette.name}
                    onClick={() => {
                      console.log('📈 LineChartEditor: Color palette changed to:', palette.name)
                ...
                {(chartConfig.styling?.colors || ['#2563eb']).slice(1, 5).map((color, index) => (
                  <div key={index}>
                    ...
                    <input
                      ...
                      value={color || '#2563eb'}
                      onChange={(e) => {
                        console.log(`📈 LineChartEditor: Color ${index + 2} changed to:`, e.target.value)
                        const newColors = [...(chartConfig.styling?.colors || ['#2563eb'])]
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="flex items-center gap-2 text-xs">
                <input
                  ...
                  onChange={(e) => {
                    console.log('📈 LineChartEditor: Show legend changed to:', e.target.checked)
              ...
              <label className="flex items-center gap-2 text-xs">
                <input
                  ...
                  onChange={(e) => {
                    console.log('📈 LineChartEditor: Show grid changed to:', e.target.checked)
