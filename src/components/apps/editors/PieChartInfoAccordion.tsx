              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      console.log('🥧 PieChartEditor: X position changed to:', value)
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value) || 0
                      console.log('🥧 PieChartEditor: Y position changed to:', value)
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      console.log('🥧 PieChartEditor: Width changed to:', value)
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value) || 1
                      console.log('🥧 PieChartEditor: Height changed to:', value)
