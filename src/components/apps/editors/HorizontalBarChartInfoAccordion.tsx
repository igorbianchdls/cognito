              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      console.log('📊 HorizontalBarChartEditor: X position changed to:', value)
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value) || 0
                      console.log('📊 HorizontalBarChartEditor: Y position changed to:', value)
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      console.log('📊 HorizontalBarChartEditor: Width changed to:', value)
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value) || 1
                      console.log('📊 HorizontalBarChartEditor: Height changed to:', value)
