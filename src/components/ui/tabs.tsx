  ...
  if (variant === 'underline') {
    ...
    return (
      <button
        ...
        disabled={disabled}
        className={`inline-flex items-center justify-center whitespace-nowrap px-0 py-0 text-sm font-medium border-b-2 transition-colors rounded-none ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ${
