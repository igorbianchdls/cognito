      ...
      <div className="flex-1 overflow-auto">
        <div className="p-4">
          <div className="bg-gray-900 rounded-lg overflow-hidden">
            {/* Table Header */}
            <div className="grid grid-cols-[1fr,2fr,auto] gap-4 px-4 py-3 bg-gray-800 border-b border-gray-700 text-sm font-medium text-gray-400">
              <div>Key</div>
              <div>Value</div>
            ...
            <div className="divide-y divide-gray-800">
              {mockFields.map((field, index) => (
                <div
                  key={index}
                  className="grid grid-cols-[1fr,2fr,auto] gap-4 px-4 py-3 hover:bg-gray-800/50 transition-colors group"
                >
