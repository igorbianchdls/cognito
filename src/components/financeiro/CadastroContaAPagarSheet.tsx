...
export default function CadastroContaAPagarSheet({ triggerLabel = "Cadastrar", onSaved }: Props) {
  ...
  const reset = () => { setDescricao(""); setValor(""); setDataLanc(""); setDataVenc(""); setFornecedorId(""); setCategoriaId(""); setContaId(""); setStatus("pendente"); setTenantId(""); setError(null) }
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-screen max-w-3xl p-0">
        <div className="h-full flex flex-col">
          <SheetHeader className="p-4 border-b"><SheetTitle>Nova Conta a Pagar</SheetTitle><SheetDescription>Preencha os dados da conta</SheetDescription></SheetHeader>
