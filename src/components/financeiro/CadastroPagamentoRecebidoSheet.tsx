...
export default function CadastroPagamentoRecebidoSheet({ triggerLabel = "Cadastrar", onSaved }: Props) {
  ...
  const reset = () => { setDescricao(""); setValor(""); setDataLanc(""); setClienteId(""); setCategoriaId(""); setContaId(""); setStatus(""); setTenantId(""); setError(null) }
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-screen max-w-3xl p-0">
        <div className="h-full flex flex-col">
          <SheetHeader className="p-4 border-b"><SheetTitle>Novo Pagamento Recebido</SheetTitle><SheetDescription>Preencha os dados do recebimento</SheetDescription></SheetHeader>
