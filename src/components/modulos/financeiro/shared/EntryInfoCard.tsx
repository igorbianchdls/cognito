    ...
    <Card className="p-4 mx-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
        ...
        <div className="md:col-span-4">
          <Label className="text-xs text-slate-600">{entityLabel}</Label>
        ...
        <div className="md:col-span-3">
          <Label className="text-xs text-slate-600">{categoryLabel}</Label>
        ...
        <div className="md:col-span-3">
          <Label className="text-xs text-slate-600">{centerLabel}</Label>
