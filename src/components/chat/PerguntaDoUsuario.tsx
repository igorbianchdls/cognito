  ...
  return (
    <div className="flex justify-end mb-8">
      <div className="max-w-[85%]">
        ...
        {files && files.length > 0 && (
          <div className="mb-4">
            <div className="grid gap-2 grid-cols-1 sm:grid-cols-2">
              {files.map((file) => (
                <div key={file.id} className="bg-muted border border-border rounded-lg p-3 flex items-center gap-3">
        ...
        {/* Message Bubble */}
        <div className="bg-[#f8f9fa] dark:bg-[#2d2d2d] rounded-2xl px-4 py-3 border border-border/50">
