...
const DASHBOARD_SKILL_MD = [
  ...
  '- Fonte de verdade de tabelas/medidas/dimensoes: `GET /api/modulos/query/catalog`.',
  '- No JSON atual, use `dataQuery.model` (equivale ao nome da tabela no catalogo).',
  ...
  '',
  '## Tabelas e Campos para Visualizacao',
  '',
  '### Vendas (`/api/modulos/vendas/query`)',
  '- Tabela (model no JSON) suportada: `vendas.pedidos`.',
  ...
  '- Tabelas (models no JSON) suportadas: `compras.compras`, `compras.recebimentos`.',
  ...
  '- Tabelas (models no JSON) suportadas: `financeiro.contas_pagar`, `financeiro.contas_receber`.',
