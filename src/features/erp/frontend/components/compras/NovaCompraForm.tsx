...
import EntryInfoCard, { type EntryInfoValues } from "@/features/erp/frontend/components/financeiro/shared/EntryInfoCard"
import PaymentConditionHeader, { type PaymentConditionConfig } from "@/features/erp/frontend/components/financeiro/shared/PaymentConditionHeader"
import ParcelasEditor, { type Parcela } from "@/features/erp/frontend/components/financeiro/shared/ParcelasEditor"
import CompraItemsEditor, { type CompraItem } from "@/features/erp/frontend/components/compras/CompraItemsEditor"
...
export default function NovaCompraForm() {
  ...
  async function onSalvar() {
    ...
    try {
      ...
      router.push('/erp/compras?tab=compras')
    } catch (e) {
    ...
    <div className="space-y-4">
      ...
      <Card className="p-4 mx-4 space-y-2">
        ...
        <div className="flex items-center justify-between">
          <Button variant="outline" onClick={() => router.push('/erp/compras?tab=compras')} disabled={isSaving}>Cancelar</Button>
