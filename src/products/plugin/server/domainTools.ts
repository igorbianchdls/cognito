...
const ERP_ACOES_DOMAIN_TOOL_DEFINITION = {
  name: PLUGIN_DOMAIN_TOOL_NAMES.erpAcoes,
  title: 'ERP acoes',
  description:
...
const CRM_DOMAIN_TOOL_DEFINITION = {
  name: PLUGIN_DOMAIN_TOOL_NAMES.crm,
  title: 'CRM',
  description:
...
const SQL_DOMAIN_TOOL_DEFINITION = {
  name: PLUGIN_DOMAIN_TOOL_NAMES.sql,
  title: 'SQL',
  description:
...
const FINANCIAL_STATEMENT_TOOL_DEFINITION = {
  name: PLUGIN_DOMAIN_TOOL_NAMES.financialStatement,
...
const MARKETING_DOMAIN_TOOL_DEFINITION = {
  name: PLUGIN_DOMAIN_TOOL_NAMES.marketing,
...
const PLUGIN_DOMAIN_TOOL_NAME_SET = new Set<string>(
  Object.values(PLUGIN_DOMAIN_TOOL_NAMES),
)
...
function makeDataCatalogResult(input: {
  ...
  const structuredContent = {
    success: true,
    tool: PLUGIN_DOMAIN_TOOL_NAMES.dataCatalog,
    view: 'data_catalog',
    action: input.action,
...
function buildErpAcoesResponse(input: {
  ...
  const structuredContent = {
    success,
    tool: PLUGIN_DOMAIN_TOOL_NAMES.erpAcoes,
    action,
    resource,
...
async function callFinancialStatement(args: unknown, context: CognitoMcpServerContext) {
  ...
  const structuredContent = {
    success: true,
    tool: PLUGIN_DOMAIN_TOOL_NAMES.financialStatement,
    view: 'table',
    kind,
...
async function callSqlExecution(
  args: unknown,
  context: CognitoMcpServerContext,
  toolName: string = PLUGIN_DOMAIN_TOOL_NAMES.sql,
) {
  const input = toObj(args)
...
export async function callPluginDomainTool(
  name: string,
  args: unknown,
  context: CognitoMcpServerContext = {},
) {
  switch (name) {
    case PLUGIN_DOMAIN_TOOL_NAMES.erp:
    ...
    case PLUGIN_DOMAIN_TOOL_NAMES.sqlExecution:
      return callSqlExecution(args, context, PLUGIN_DOMAIN_TOOL_NAMES.sqlExecution)
    case PLUGIN_DOMAIN_TOOL_NAMES.financialStatement:
