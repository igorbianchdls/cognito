import type { ConnectedCrmProviderAction, ConnectedCrmResource } from '@/products/plugin/server/domain-adapters/crm/crmTypes'
import {
...
} from '@/products/plugin/server/domain-adapters/crm/providers/preOAuthCrmApiAdapters'
