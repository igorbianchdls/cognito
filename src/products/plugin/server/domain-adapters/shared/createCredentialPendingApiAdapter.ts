...
import type { IntegrationProviderPluginCapabilities } from '@/products/integracoes/shared/providers/pluginProviderCapabilities'
import type {
...
export function createCredentialPendingApiAdapter<Resource extends string, Action extends string>(
  capability: IntegrationProviderPluginCapabilities,
