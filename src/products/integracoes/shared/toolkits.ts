...
export const TOOLKITS: ToolkitDefinition[] = [
  ...
  { slug: 'WHATSAPP', name: 'WhatsApp', description: 'Conversas e atendimento pelo WhatsApp' },
  { slug: 'INSTAGRAM_DM', name: 'Instagram DM', description: 'Mensagens diretas do Instagram' },
  { slug: 'FACEBOOK_MESSENGER', name: 'Facebook Messenger', description: 'Conversas e atendimento pelo Messenger' },
