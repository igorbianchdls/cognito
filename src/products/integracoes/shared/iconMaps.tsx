...
import {
  ...
  SicrediIcon,
  SicoobIcon,
} from '@/components/icons/BankLogos'
...
const CUSTOM_ICON_BY_SLUG: Record<string, ComponentType<any>> = {
  ...
  BANCO_DO_BRASIL: BancoDoBrasilIcon,
  BANCO_INTER: BancoInterIcon,
  BANRISUL: BanrisulIcon,
  BLING: BlingIcon,
  BRADESCO: BradescoIcon,
  BTG_PACTUAL: BtgPactualIcon,
  C6_BANK: C6BankIcon,
  CAIXA: CaixaIcon,
...
export const SIMPLE_ICON_BY_SLUG: Record<string, ComponentType<any>> = {
  ...
  SLACK: SiSlack,
  WHATSAPP: SiWhatsapp,
  INSTAGRAM_DM: SiInstagram,
  FACEBOOK_MESSENGER: SiMessenger,
  SHOPIFY: SiShopify,
  HUBSPOT: SiHubspot,
  FACEBOOK: SiFacebook,
