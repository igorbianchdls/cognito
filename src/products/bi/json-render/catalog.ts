    ...
    BarChart: {
      props: z.object({
        ...
        nivo: z.object({
          ...
          legends: z.array(z.record(z.any())).optional(),
          markers: z.array(z.record(z.any())).optional(),
          tooltip: z.object({
            showLabel: z.boolean().optional(),
            showValue: z.boolean().optional(),
            showSeries: z.boolean().optional(),
            showPercentOfGroup: z.boolean().optional(),
          }).partial().optional(),
          ...
          maxLabelWidth: z.number().optional(),
        }).partial().optional(),
      }).strict(),
      hasChildren: false,
    },
    LineChart: {
      props: z.object({
        ...
        nivo: z.object({
          ...
          pointColor: z.any().optional(),
          pointBorderColor: z.any().optional(),
          useMesh: z.boolean().optional(),
          enableSlices: z.union([z.boolean(), z.enum(["x", "y"])]).optional(),
          xScale: z.record(z.any()).optional(),
          yScale: z.record(z.any()).optional(),
      ...
      props: z.object({
        ...
        nivo: z.object({
          ...
          tooltip: z.object({
            showLabel: z.boolean().optional(),
            showValue: z.boolean().optional(),
            showPercentOfTotal: z.boolean().optional(),
          }).partial().optional(),
          margin: z.object({ top: z.number().optional(), right: z.number().optional(), bottom: z.number().optional(), left: z.number().optional() }).partial().optional(),
          animate: z.boolean().optional(),
          motionConfig: z.string().optional(),
