        ...
        <div className="space-y-3 p-3">
          ...
          {selectedPath && (
            <>
              ...
              {activeTab === 'data' && (node.type === 'Header' || node.type === 'SlicerCard' || node.type === 'Table') && (
                <TextField
                  label="Título"
              ...
              {activeTab === 'data' && (node.type === 'SlicerCard' || node.type === 'Table') && (
                <CheckboxField
                  label="Borderless"
              ...
              {activeTab === 'style' && (
                <>
                  ...
                  {(node.type === 'Header' || node.type === 'SlicerCard' || node.type === 'Card' || node.type === 'CardTitle' || node.type === 'Title' || node.type === 'AISummary' || node.type === 'Table') && (
                    <TextField
                  ...
                  {(node.type === 'SlicerCard' || node.type === 'Gauge' || node.type === 'AISummary' || node.type === 'Table') && (
                    <div className="space-y-2 rounded border border-gray-200 p-2">
