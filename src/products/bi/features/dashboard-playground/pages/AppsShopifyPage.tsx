  ...
  return (
    <div className="min-h-screen">
      <div className="w-full">
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">Apps — Shopify</h1>
        <p className="text-sm text-gray-600 mb-6">Dashboard completo de e-commerce para Shopify.</p>

        <DataProvider initialData={{ ecommerce: { dashboard: {}, kpis: {} }, filters: { plataforma: 'shopify' } }}>
          <AppsShopifyPlayground />
        </DataProvider>
      </div>
    </div>
  )
