...
import { APPS_ECOMMERCE_TEMPLATE_TEXT } from '@/products/bi/shared/templates/appsEcommerceTemplate'

function AppsEcommercePlayground() {
  const {
    jsonText,
    parseError,
    tree,
    ...
    setNodeProp,
    replaceNodeProps,
  } = useJsonTemplateEditor(APPS_ECOMMERCE_TEMPLATE_TEXT)
...
export default function AppsEcommercePage() {
  return (
    <div className="min-h-screen">
      <div className="w-full">
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">Apps — E-commerce</h1>
        <p className="text-sm text-gray-600 mb-6">Dashboard consolidado com Amazon, Mercado Livre, Shopee e Shopify.</p>

        <DataProvider initialData={{ ecommerce: { dashboard: {}, kpis: {} }, filters: {} }}>
          <AppsEcommercePlayground />
        </DataProvider>
      </div>
    </div>
  )
