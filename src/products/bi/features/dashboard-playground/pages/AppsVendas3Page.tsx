...
import { APPS_VENDAS3_TEMPLATE_DSL } from '@/products/bi/shared/templates/appsVendas3Template'

function AppsVendas3Playground() {
  ...
  const {
    ...
    setNodeProp,
    replaceNodeProps,
  } = useDslTemplateEditor(APPS_VENDAS3_TEMPLATE_DSL)
...
export default function AppsVendas3Page() {
  return (
    <div className="min-h-screen">
      <div className="w-full">
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">Apps — Vendas 3</h1>
        <p className="text-sm text-gray-600 mb-6">Template de teste para scatter, radar e treemap.</p>

        <DataProvider initialData={{}}>
          <AppsVendas3Playground />
        </DataProvider>
      </div>
    </div>
  )
