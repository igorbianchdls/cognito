...
import { APPS_MERCADOLIVRE_TEMPLATE_TEXT } from '@/products/bi/shared/templates/appsMercadoLivreTemplate'

function AppsMercadoLivrePlayground() {
  const {
    jsonText,
    parseError,
    tree,
    ...
    setNodeProp,
    replaceNodeProps,
  } = useJsonTemplateEditor(APPS_MERCADOLIVRE_TEMPLATE_TEXT)
...
export default function AppsMercadoLivrePage() {
  return (
    <div className="min-h-screen">
      <div className="w-full">
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">Apps — Mercado Livre</h1>
        <p className="text-sm text-gray-600 mb-6">Dashboard completo de e-commerce para Mercado Livre.</p>

        <DataProvider initialData={{ ecommerce: { dashboard: {}, kpis: {} }, filters: { plataforma: 'mercadolivre' } }}>
          <AppsMercadoLivrePlayground />
        </DataProvider>
      </div>
    </div>
  )
