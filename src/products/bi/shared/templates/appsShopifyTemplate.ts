...
export const APPS_SHOPIFY_TEMPLATE_TEXT = JSON.stringify(migrateTemplateDataQueries(
  [
    {
      type: 'Theme',
      props: {
          ...
          children: [
            ...
            },
            {
              ...
              props: {
                ...
                items: [
                  { icon: 'trendingUp', text: 'Shopify com evolução consistente de receita líquida; ampliar catálogo premium pode aumentar ticket.' },
                  { icon: 'sparkles', text: 'Recompra e clientes recorrentes sustentam margem melhor que canais de marketplace.' },
                  { icon: 'triangleAlert', text: 'Custos de frete e reembolso em semanas de pico podem reduzir o resultado final do mês.' },
                ],
              },
            },
          ],
...
export const APPS_SHOPIFY_TEMPLATE_DSL = renderDashboardTemplateDslFromJsonText(APPS_SHOPIFY_TEMPLATE_TEXT, 'apps_shopify_template_dsl')
