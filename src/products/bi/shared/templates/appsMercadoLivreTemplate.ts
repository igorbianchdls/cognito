export const APPS_MERCADOLIVRE_TEMPLATE_DSL = String.raw`<DashboardTemplate name="apps_mercadolivre_template_dsl">
  <Theme name="light">
    <Config>
      {
        "managers": {
    ...
    <Header title="Dashboard Mercado Livre" subtitle="E-commerce • Vendas, logística, financeiro e estoque" direction="row" justify="between" align="center">
        ...
        <Config>
          {
            ...
            "items": [
              {
                "icon": "trendingUp",
                "text": "Mercado Livre com bom ritmo de pedidos capturados; reforçar reposição evita ruptura nos campeões de venda."
              },
              {
                "icon": "sparkles",
                "text": "Concentração de receita em poucas contas pode esconder oportunidades de escala em lojas menores."
              },
              {
                "icon": "triangleAlert",
                "text": "Cancelamentos e devoluções acima da média impactam margem e recebimento líquido do ciclo."
              }
            ]
          }
        </Config>
