...
export const APPS_MERCADOLIVRE_TEMPLATE_TEXT = JSON.stringify(migrateTemplateDataQueries(
  [
    {
      type: 'Theme',
      props: {
        ...
        managers: {
          ...
          color: {
            scheme: ['#FFE600', '#2D3277', '#00A650', '#34D399', '#F59E0B'],
          },
        },
      },
      children: [
          ...
          children: [
            ...
            },
            {
              ...
              props: {
                ...
                items: [
                  { icon: 'trendingUp', text: 'Mercado Livre com bom ritmo de pedidos capturados; reforçar reposição evita ruptura nos campeões de venda.' },
                  { icon: 'sparkles', text: 'Concentração de receita em poucas contas pode esconder oportunidades de escala em lojas menores.' },
                  { icon: 'triangleAlert', text: 'Cancelamentos e devoluções acima da média impactam margem e recebimento líquido do ciclo.' },
                ],
              },
            },
          ],
...
export const APPS_MERCADOLIVRE_TEMPLATE_DSL = renderDashboardTemplateDslFromJsonText(APPS_MERCADOLIVRE_TEMPLATE_TEXT, 'apps_mercadolivre_template_dsl')
