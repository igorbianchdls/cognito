  ...
  [
    {
      ...
      props: {
        ...
        managers: {
          ...
          color: {
            scheme: ['#FF9900', '#232F3E', '#146EB4', '#34D399', '#F59E0B'],
          },
        },
      },
      children: [
          ...
          children: [
            ...
            },
            {
              ...
              props: {
                ...
                items: [
                  { icon: 'trendingUp', text: 'Amazon cresce em pedidos capturados; priorize reposição dos SKUs com maior giro.' },
                  { icon: 'sparkles', text: 'Fee rate elevado em contas específicas indica oportunidade de otimizar mix e preço.' },
                  { icon: 'triangleAlert', text: 'Picos de reembolso e atrasos logísticos podem pressionar o payout líquido do mês.' },
                ],
              },
            },
          ],
...
export const APPS_AMAZON_TEMPLATE_DSL = renderDashboardTemplateDslFromJsonText(APPS_AMAZON_TEMPLATE_TEXT, 'apps_amazon_template_dsl')
