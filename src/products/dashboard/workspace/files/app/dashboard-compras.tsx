...
export function DashboardCompras() {
  ...
  const CHART_COLORS = DASHBOARD_CHART_PALETTES[CHART_PALETTE] ?? ["#1D4ED8","#3B82F6","#60A5FA","#93C5FD","#BFDBFE"]
  ...
  return (
    <DashboardTemplate name="dashboard_compras" title="Dashboard de Compras">
      <Theme name={THEME_NAME} />
      <Dashboard id="overview" title="Dashboard de Compras">
