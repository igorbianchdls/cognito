...
export function DashboardGoogleAds() {
  const THEME_NAME = "metro"
  const CHART_PALETTE = 'orange'
  const CHART_COLORS = DASHBOARD_CHART_PALETTES[CHART_PALETTE] ?? ["#EA580C","#F97316","#FB923C","#FDBA74","#FED7AA"]
  ...
  return (
    <DashboardTemplate name="dashboard_googleads" title="Dashboard Google Ads">
      <Theme name={THEME_NAME} />
      <Dashboard id="overview" title="Dashboard Google Ads">
