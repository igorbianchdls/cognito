...
export const DASHBOARD_BUILDER_TOOL_PARAMETERS = {
  ...
  properties: {
    ...
    dashboard_name: {
      type: 'string',
      description:
        'Nome técnico do dashboard (chave de estado e nome do arquivo em /vercel/sandbox/dashboard/<dashboard_name>.dsl). Use o mesmo dashboard_name em todas as chamadas do mesmo dashboard.',
    },
    title: {
      type: 'string',
