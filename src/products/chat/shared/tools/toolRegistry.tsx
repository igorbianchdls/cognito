...
import { CrudToolPart } from '@/products/chat/shared/tools/crud/CrudToolPart'
...
export function renderSharedToolPart(part: AgentToolPartLike, idx: number): ReactNode | null {
  ...
  if (part.type === 'tool-crud') {
    return <CrudToolPart key={`tool-crud-${part.toolCallId || idx}`} part={part} idx={idx} />
  }
