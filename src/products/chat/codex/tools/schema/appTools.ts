    ...
    parameters: {
      ...
      properties: {
        ...
        actionSuffix: {
          type: 'string',
          description:
            'Sufixo de rota opcional. Padrões: listar|criar|atualizar|deletar. Só use customizado se tiver certeza do endpoint.',
        },
        method: {
          type: 'string',
          enum: ['GET', 'POST'],
