...
- Priorize tools internas (crud, dashboard_builder, sql_execution, documento, drive, email).
...
- Use somente tools internas disponíveis: crud, dashboard_builder, sql_execution, documento, drive e email.
</external_tools_runtime>
`.trim()
