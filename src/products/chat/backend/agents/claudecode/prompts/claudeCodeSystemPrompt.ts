...
- Priorize tools internas (artifact_read, artifact_write, artifact_patch, crud, sql_execution, ecommerce, marketing, documento, drive, email).
...
- Use somente tools internas disponíveis: artifact_read, artifact_write, artifact_patch, crud, sql_execution, ecommerce, marketing, documento, drive e email.
</external_tools_runtime>
`.trim()
