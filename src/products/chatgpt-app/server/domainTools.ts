...
export const CHATGPT_DOMAIN_TOOL_DEFINITIONS = [
  ...
  {
    name: CHATGPT_DOMAIN_TOOL_NAMES.ecommerce,
  ...
  {
    name: CHATGPT_DOMAIN_TOOL_NAMES.marketing,
...
const CHATGPT_DOMAIN_TOOL_NAME_SET = new Set<string>(
  Object.values(CHATGPT_DOMAIN_TOOL_NAMES),
)
...
export async function callChatGptDomainTool(
  name: string,
  args: unknown,
