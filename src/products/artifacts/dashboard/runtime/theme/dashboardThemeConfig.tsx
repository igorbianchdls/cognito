...
import { DASHBOARD_DEFAULT_CHART_PALETTE, resolveDashboardChartPaletteColors } from '@/products/artifacts/dashboard/language/dashboardLanguageManifest'
import {
...
import type {
  ...
  DashboardTableThemeConfigEntry,
  DashboardTabThemeConfigEntry,
  DashboardTextStyle,
  DashboardTextThemeConfigEntry,
  DashboardTextVariantKey,
  DashboardThemeConfigEntry,
  DashboardThemeSelection,
} from '@/products/artifacts/dashboard/runtime/theme/types'
