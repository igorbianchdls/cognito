...
import type { DashboardAppearanceOverrides } from '@/products/artifacts/dashboard/runtime/theme'
import {
  DashboardThumbnailCaptureSurface,
  type DashboardThumbnailCaptureRequest,
  type DashboardThumbnailCaptureResult,
} from '@/products/artifacts/dashboard/preview/DashboardThumbnailCaptureSurface'
import { DASHBOARD_THUMBNAIL_SOURCE_PATH } from '@/products/artifacts/dashboard/preview/dashboardThumbnailConstants'
import { persistDashboardThumbnail } from '@/products/artifacts/dashboard/preview/persistDashboardThumbnail'
