...
import { parseDashboardJsxToTree, type DashboardTreeNode } from '@/products/artifacts/dashboard/parser/dashboardJsxParser'
...
export function DashboardArtifactPage({ source, title, embedMode }: DashboardArtifactPageProps) {
