...
import VendaInfoCard, { type VendaInfoValues } from "@/products/erp/frontend/components/vendas/VendaInfoCard"
import SaleItemsEditor, { type SaleItem } from "@/products/erp/frontend/components/vendas/SaleItemsEditor"
import VendaPagamentoCard from "@/products/erp/frontend/components/vendas/VendaPagamentoCard"
import type { PaymentConditionConfig } from "@/products/erp/frontend/components/financeiro/shared/PaymentConditionHeader"
import type { Parcela } from "@/products/erp/frontend/components/financeiro/shared/ParcelasEditor"
...
export default function NovaVendaForm() {
  ...
  const handleSalvar = async () => {
    ...
    try {
      ...
      router.push("/erp/vendas?tab=pedidos")
    } catch (e) {
