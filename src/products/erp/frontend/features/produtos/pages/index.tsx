...
import CadastroProdutoSheet from '@/products/erp/frontend/components/produtos/CadastroProdutoSheet'
import CadastroVariacaoSheet from '@/products/erp/frontend/components/produtos/CadastroVariacaoSheet'
import CadastroDadosFiscaisSheet from '@/products/erp/frontend/components/produtos/CadastroDadosFiscaisSheet'
                  ...
                  dateRangeWidth={toolbarUI.dateRangeWidth}
                      actionComponent={
                        tabs.selected === 'vendas' ? (
                          <Link href="/erp/vendas/pedidos/novo" className="inline-flex"><Button variant="default">Cadastrar Venda</Button></Link>
