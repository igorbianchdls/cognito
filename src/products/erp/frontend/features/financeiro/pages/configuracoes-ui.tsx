...
import UiConfigPanel from '@/products/erp/frontend/components/UiConfigPanel'
import DataToolbar from '@/products/erp/frontend/components/DataToolbar'
import { $titulo, $tabs, $tabelaUI, $layout, $toolbarUI, $catalogUI, financeiroUiActions } from '@/products/erp/state/financeiroUiStore'
