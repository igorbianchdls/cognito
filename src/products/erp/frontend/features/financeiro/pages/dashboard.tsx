...
import {
  ...
  toDateOnly,
  toNum,
} from '@/products/erp/frontend/features/financeiro/dashboard/utils'
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="text-xl font-semibold text-slate-800" style={{ ...styleKpiTitle, fontSize: 16 }}>Hoje</div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="text-xl font-semibold text-slate-800" style={{ ...styleKpiTitle, fontSize: 16 }}>Overview</div>
