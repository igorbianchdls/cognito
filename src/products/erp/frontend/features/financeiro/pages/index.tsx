...
import DocumentViewer from '@/products/erp/frontend/components/documentos/DocumentViewer'
...
import FornecedorEditorSheet from '@/products/erp/frontend/components/financeiro/FornecedorEditorSheet'
import ClienteEditorSheet from '@/products/erp/frontend/components/financeiro/ClienteEditorSheet'
import BancoEditorSheet from '@/products/erp/frontend/components/financeiro/BancoEditorSheet'
...
import CadastroBancoSheet from '@/products/erp/frontend/components/financeiro/CadastroBancoSheet'
import CadastroContaFinanceiraSheet from '@/products/erp/frontend/components/financeiro/CadastroContaFinanceiraSheet'
import CategoriaDespesaEditorModal from '@/products/erp/frontend/components/financeiro/CategoriaDespesaEditorModal'
import CadastroCategoriaReceitaSheet from '@/products/erp/frontend/components/financeiro/CadastroCategoriaReceitaSheet'
import CadastroCategoriaDespesaSheet from '@/products/erp/frontend/components/financeiro/CadastroCategoriaDespesaSheet'
import CategoriaReceitaEditorModal from '@/products/erp/frontend/components/financeiro/CategoriaReceitaEditorModal'
import ApKpiRow from '@/products/erp/frontend/components/financeiro/ApKpiRow'
...
import LinhasContaPagar from '@/products/erp/frontend/features/financeiro/components/LinhasContaPagar'
import LinhasPagamentoEfetuado from '@/products/erp/frontend/features/financeiro/components/LinhasPagamentoEfetuado'
import LinhasPagamentoRecebido from '@/products/erp/frontend/features/financeiro/components/LinhasPagamentoRecebido'
import LinhasContaReceber from '@/products/erp/frontend/features/financeiro/components/LinhasContaReceber'
            ...
            cell: ({ row }) => (
              <RowActionsMenu
                ...
                onInformRecebimento={() => {
                  ...
                  if (id) router.push(`/erp/financeiro/contas-a-receber/receber?id=${id}`)
                }}
            ...
            cell: ({ row }) => (
              <RowActionsMenu
                ...
                onInformPagamento={() => {
                  ...
                  if (id) router.push(`/erp/financeiro/contas-a-pagar/pagar?id=${id}`)
                }}
            ...
            <DataToolbar
              ...
              actionComponent={
                tabs.selected === 'contas-a-pagar' ? (
                  <Link href="/erp/financeiro/contas-a-pagar/novo" className="inline-flex">
                    <Button variant="default">Cadastrar</Button>
                  </Link>
                ) : tabs.selected === 'contas-a-receber' ? (
                  <Link href="/erp/financeiro/contas-a-receber/novo" className="inline-flex">
                    <Button variant="default">Cadastrar</Button>
                  </Link>
