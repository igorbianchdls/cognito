                    ...
                    <DataToolbar
                      ...
                      actionComponent={
                        tabs.selected === 'contratos' ? (
                          <Link href="/erp/servicos/contratos/novo" className="inline-flex"><Button variant="default">Cadastrar</Button></Link>
                        ) : tabs.selected === 'vendas' ? (
                          <Link href="/erp/vendas/pedidos/novo" className="inline-flex"><Button variant="default">Cadastrar Venda</Button></Link>
                        ) : tabs.selected === 'nota-fiscal' ? (
                          <Link href="/erp/servicos/nota-fiscal/emitir" className="inline-flex"><Button variant="default">Emitir NFS-e</Button></Link>
