...
function SlideWorkspace() {
  ...
  return (
    <div className="flex h-screen flex-col bg-[#080808] tracking-[-0.03em] text-[#F2F3F4]">
      <header className="flex items-center justify-between border-b-[0.5px] border-[#2A2A2A] bg-[#080808] px-5 py-3 backdrop-blur">
        ...
        <div className="flex items-center gap-2">
          <div className="mr-2 flex h-10 items-center gap-1 rounded-lg border-[0.5px] border-[#2A2A2A] bg-[#1B1B1B] px-1">
            <button
              type="button"
      ...
      <div className="flex min-h-0 flex-1">
        <aside className="w-[210px] shrink-0 overflow-auto border-r-[0.5px] border-[#2A2A2A] bg-[#080808] px-3 py-4">
        ...
        <main className="min-h-0 flex-1 overflow-auto border-r-[0.5px] border-[#2A2A2A] bg-[#121212]">
