...
const FINANCE_TEMPLATE_TEXT = JSON.stringify([
  {
    ...
    props: { name: "light" },
    children: [
      { type: "Header", props: { title: "Dashboard Financeiro", subtitle: "Contas a Pagar e Receber", align: "center", datePicker: { visible: true, mode: "range", position: "right", storePath: "filters.dateRange", actionOnChange: { type: "refresh_data" }, style: { padding: 6, fontFamily: "Barlow", fontSize: 12 } } } },

      { type: "Div", props: { direction: "row", gap: 12, padding: 16, justify: "start", align: "start", childGrow: true }, children: [
        { type: "BarChart", props: { fr: 1, title: "AP por Fornecedor", dataQuery: { model: "financeiro.contas_pagar", dimension: "fornecedor", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "fornecedor", yKey: "valor_total", format: "currency", height: 240, nivo: { layout: 'horizontal' } } },
        { type: "BarChart", props: { fr: 1, title: "AR por Centro de Lucro", dataQuery: { model: "financeiro.contas_receber", dimension: "centro_lucro", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "centro_lucro", yKey: "valor_total", format: "currency", height: 240, nivo: { layout: 'horizontal' } } },
        { type: "BarChart", props: { fr: 1, title: "AP por Categoria (Despesa)", dataQuery: { model: "financeiro.contas_pagar", dimension: "categoria_despesa", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "categoria_despesa", yKey: "valor_total", format: "currency", height: 240, nivo: { layout: 'horizontal' } } }
      ]},

      { type: "Div", props: { direction: "row", gap: 12, padding: 16, justify: "start", align: "start", childGrow: true }, children: [
        { type: "BarChart", props: { fr: 1, title: "AP por Centro de Custo", dataQuery: { model: "financeiro.contas_pagar", dimension: "centro_custo", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "centro_custo", yKey: "valor_total", format: "currency", height: 220, nivo: { layout: 'horizontal' } } },
        { type: "BarChart", props: { fr: 1, title: "AP por Departamento", dataQuery: { model: "financeiro.contas_pagar", dimension: "departamento", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "departamento", yKey: "valor_total", format: "currency", height: 220, nivo: { layout: 'horizontal' } } },
        { type: "BarChart", props: { fr: 1, title: "AP por Filial", dataQuery: { model: "financeiro.contas_pagar", dimension: "filial", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "filial", yKey: "valor_total", format: "currency", height: 220, nivo: { layout: 'horizontal' } } }
      ]},

      { type: "Div", props: { direction: "row", gap: 12, padding: 16, justify: "start", align: "start", childGrow: true }, children: [
        { type: "BarChart", props: { fr: 1, title: "AP por Unidade de Negócio", dataQuery: { model: "financeiro.contas_pagar", dimension: "unidade_negocio", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "unidade_negocio", yKey: "valor_total", format: "currency", height: 220, nivo: { layout: 'horizontal' } } },
        { type: "BarChart", props: { fr: 1, title: "AR por Categoria (Receita)", dataQuery: { model: "financeiro.contas_receber", dimension: "categoria_receita", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "categoria_receita", yKey: "valor_total", format: "currency", height: 220, nivo: { layout: 'horizontal' } } },
        { type: "BarChart", props: { fr: 1, title: "AR por Cliente", dataQuery: { model: "financeiro.contas_receber", dimension: "cliente", measure: "SUM(valor_liquido)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 8 }, xKey: "cliente", yKey: "valor_total", format: "currency", height: 220, nivo: { layout: 'horizontal' } } }
      ]},
