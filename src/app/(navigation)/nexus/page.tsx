...
export default function Page() {
  ...
  const getApiUrl = (agentOrWorkflow: string) => {
    switch (agentOrWorkflow) {
      ...
      case 'conciliacao-bancaria': return '/api/workflows/conciliacao-bancaria';
  ...
  */
  ...
  return (
    <SidebarProvider>
      <SidebarShadcn borderless headerBorderless headerVariant="compact" />
          ...
          {viewMode === 'chat' && (
            ...
            <div className="flex flex-col h-full w-full">
              ...
              <div className="flex-1 min-h-0 pl-2 pr-2 pt-0 pb-2" data-page="nexus">
                <NexusPageContainer className="h-full" showSidebarTrigger style={{ backgroundColor: '#f3f4f6', borderWidth: 0 }}>
