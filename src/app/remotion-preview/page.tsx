...
const catalog: CatalogItem[] = [
  ...
  {
    code: '<ChatGptMobileSalesCollectionsVideo />',
    component: ChatGptMobileSalesCollectionsVideo,
    description: 'Conversa mobile que registra vendas e notas, envia os documentos e cobra clientes com pagamentos pendentes.',
    duration: CHATGPT_MOBILE_SALES_COLLECTIONS_DURATION,
    fps: 90,
    height: 1792,
    kind: 'Vídeos criados',
    label: 'ChatGPT Mobile — Registro de Vendas e Cobranças',
    tags: ['ChatGPT', 'Mobile', 'Otto', 'Vendas', 'Notas fiscais', 'Cobranças'],
    value: 'video-chatgpt-mobile-sales-collections',
    width: 828,
  },
  {
    code: '<ChatGptMobileUninvoicedSalesVideo />',
    component: ChatGptMobileUninvoicedSalesVideo,
    description: 'Conversa mobile que encontra vendas sem nota, emite os documentos e envia tudo pelo WhatsApp com resumo final.',
    duration: CHATGPT_MOBILE_UNINVOICED_SALES_DURATION,
    fps: 90,
    height: 1792,
    kind: 'Vídeos criados',
    label: 'ChatGPT Mobile — Vendas sem Nota pelo WhatsApp',
    tags: ['ChatGPT', 'Mobile', 'Otto', 'Vendas', 'Notas fiscais', 'WhatsApp'],
    value: 'video-chatgpt-mobile-uninvoiced-sales',
    width: 828,
  },
  {
