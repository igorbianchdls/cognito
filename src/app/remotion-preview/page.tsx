...
import {
  ...
  OttoAuditTrailScene,
  OttoDecisionTimelineScene,
  OttoExceptionQueueScene,
  OttoMarginLeakInsightScene,
  OttoMultiAgentHandoffScene,
} from '@/assets/remotion/compositions/OttoFinancialSceneComponents'
import {
  OTTO_LOGO_VARIANT_DURATION,
  OttoLogoDarkStamp,
  OttoLogoLightSweep,
  OttoLogoSignalGrid,
  OttoLogoSoftPulse,
} from '@/assets/remotion/compositions/OttoLogoVariants'
...
const catalog: CatalogItem[] = [
  ...
  },
  {
    ...
    component: OttoLogoSoftPulse,
    description: 'Logo Otto oficial com pulso suave e anel de foco.',
    duration: OTTO_LOGO_VARIANT_DURATION,
    height: 720,
    kind: 'Logo',
    label: 'Otto Logo Soft Pulse',
    tags: ['Logo', 'Otto', 'Pulse'],
    value: 'otto-logo-soft-pulse',
    width: 1280,
  },
  {
    code: '<OttoLogoLightSweep />',
    component: OttoLogoLightSweep,
    description: 'Logo Otto oficial com sweep de luz em card limpo.',
    duration: OTTO_LOGO_VARIANT_DURATION,
    height: 720,
    kind: 'Logo',
    label: 'Otto Logo Light Sweep',
    tags: ['Logo', 'Otto', 'Sweep'],
    value: 'otto-logo-light-sweep',
    width: 1280,
  },
  {
    code: '<OttoLogoSignalGrid />',
    component: OttoLogoSignalGrid,
    description: 'Logo Otto oficial sobre grid tecnico com varredura.',
    duration: OTTO_LOGO_VARIANT_DURATION,
    height: 720,
    kind: 'Logo',
    label: 'Otto Logo Signal Grid',
    tags: ['Logo', 'Otto', 'Grid'],
    value: 'otto-logo-signal-grid',
    width: 1280,
  },
  {
    code: '<OttoLogoDarkStamp />',
    component: OttoLogoDarkStamp,
    description: 'Logo Otto oficial em versao escura com entrada premium.',
    duration: OTTO_LOGO_VARIANT_DURATION,
    height: 720,
    kind: 'Logo',
    label: 'Otto Logo Dark Stamp',
    tags: ['Logo', 'Otto', 'Dark'],
    value: 'otto-logo-dark-stamp',
    width: 1280,
  },
  {
  ...
  {
    code: '<OttoHookSingleInvoiceVideo />',
    component: OttoHookSingleInvoiceVideo,
    description: 'Emissão de uma nota pelo ChatGPT, com cliente, serviço, valor, envio e automações financeiras.',
    duration: OTTO_HOOK_1_DURATION,
    fps: 30,
    height: 800,
    kind: 'Body Animado',
    label: 'Hook 1 -> Emissão de uma nota',
    tags: ['Hook', 'ChatGPT', 'Nota fiscal', 'Financeiro'],
    value: 'body-otto-hook-single-invoice',
    width: 1080,
  },
  {
    code: '<OttoHookBatchInvoicesVideo />',
    component: OttoHookBatchInvoicesVideo,
    description: 'Emissão de várias notas pelo ChatGPT, com conferência dos valores e acompanhamento individual.',
    duration: OTTO_HOOK_2_DURATION,
    fps: 30,
    height: 800,
    kind: 'Body Animado',
    label: 'Hook 2 -> Emissão de várias notas',
    tags: ['Hook', 'ChatGPT', 'Notas fiscais', 'Lote'],
    value: 'body-otto-hook-batch-invoices',
    width: 1080,
  },
  {
    code: '<OttoHookAutomatedFinanceVideo />',
    component: OttoHookAutomatedFinanceVideo,
    description: 'Financeiro automatizado no ChatGPT: vendas, notas, contas, conciliação, despesas e cobranças.',
    duration: OTTO_HOOK_3_DURATION,
    fps: 30,
    height: 800,
    kind: 'Body Animado',
    label: 'Hook 3 -> Financeiro automatizado',
    tags: ['Hook', 'ChatGPT', 'Financeiro', 'Automação'],
    value: 'body-otto-hook-automated-finance',
    width: 1080,
  },
  {
    code: '<OttoHookManageByChatVideo />',
    component: OttoHookManageByChatVideo,
    description: 'Administração da empresa por conversa com o ChatGPT, com prompts e operações em sequência.',
    duration: OTTO_HOOK_4_DURATION,
    fps: 30,
    height: 800,
    kind: 'Body Animado',
    label: 'Hook 4 -> Administre conversando',
    tags: ['Hook', 'ChatGPT', 'Conversa', 'Gestão'],
    value: 'body-otto-hook-manage-by-chat',
    width: 1080,
  },
  {
    code: '<OttoHookBoletoPixVideo />',
    component: OttoHookBoletoPixVideo,
    description: 'Geração de boleto e Pix pelo ChatGPT, envio por WhatsApp e atualização financeira.',
    duration: OTTO_HOOK_5_DURATION,
    fps: 30,
    height: 800,
    kind: 'Body Animado',
  ...
  {
    code: '<ChatGptMobilePixWhatsappVideo />',
    component: ChatGptMobilePixWhatsappVideo,
    description: 'Registra vendas, emite notas, gera um PIX por venda e envia cada nota com seu PIX pelo WhatsApp.',
    duration: CHATGPT_MOBILE_PIX_WHATSAPP_DURATION,
    fps: 90,
    height: 1792,
    kind: 'Vídeos criados',
    label: 'ChatGPT Mobile — PIX + WhatsApp',
    tags: ['ChatGPT', 'Mobile', 'Otto', 'PIX', 'WhatsApp'],
    value: 'video-chatgpt-mobile-pix-whatsapp',
    width: 828,
  },
  {
    code: '<ChatGptMobileStockWhatsappVideo />',
    component: ChatGptMobileStockWhatsappVideo,
    description: 'Registra vendas, dá baixa nos produtos do estoque, emite notas e envia os documentos por WhatsApp.',
    duration: CHATGPT_MOBILE_STOCK_WHATSAPP_DURATION,
    fps: 90,
    height: 1792,
    kind: 'Vídeos criados',
    label: 'ChatGPT Mobile — Estoque + WhatsApp',
    tags: ['ChatGPT', 'Mobile', 'Otto', 'Estoque', 'WhatsApp'],
    value: 'video-chatgpt-mobile-stock-whatsapp',
    width: 828,
  },
  {
    code: '<ChatGptMobileBoletoWhatsappVideo />',
    component: ChatGptMobileBoletoWhatsappVideo,
    description: 'Encontra vendas pendentes, emite notas, gera boletos e envia tudo pelo WhatsApp dos clientes.',
    duration: CHATGPT_MOBILE_BOLETO_WHATSAPP_DURATION,
    fps: 90,
    height: 1792,
    kind: 'Vídeos criados',
    label: 'ChatGPT Mobile — Boletos + WhatsApp',
    tags: ['ChatGPT', 'Mobile', 'Otto', 'Boletos', 'WhatsApp'],
    value: 'video-chatgpt-mobile-boleto-whatsapp',
    width: 828,
  },
  {
    code: '<ChatGptMobileCompleteSaleVideo />',
    component: ChatGptMobileCompleteSaleVideo,
    description: 'Conversa mobile que registra uma venda, emite a nota, gera a cobrança e atualiza o contas a receber.',
    duration: CHATGPT_MOBILE_COMPLETE_SALE_DURATION,
    fps: 90,
    height: 1792,
    kind: 'Vídeos criados',
    label: 'ChatGPT Mobile — Venda Completa',
    tags: ['ChatGPT', 'Mobile', 'Otto', 'Venda', 'Nota fiscal', 'Cobrança', 'Contas a receber'],
    value: 'video-chatgpt-mobile-complete-sale',
    width: 828,
  },
  {
    code: '<ChatGptMobileReconciliationInvoicesVideo />',
    component: ChatGptMobileReconciliationInvoicesVideo,
    description: 'Conversa mobile que concilia pagamentos, dá baixa nas vendas, emite notas fiscais e apresenta as pendências.',
    duration: CHATGPT_MOBILE_RECONCILIATION_INVOICES_DURATION,
    fps: 90,
    height: 1792,
    kind: 'Vídeos criados',
    label: 'ChatGPT Mobile — Conciliação e Notas Fiscais',
    tags: ['ChatGPT', 'Mobile', 'Otto', 'Conciliação', 'Notas fiscais', 'Pendências'],
    value: 'video-chatgpt-mobile-reconciliation-invoices',
    width: 828,
  },
  {
  ...
  {
    code: '<OttoDecisionTimelineScene />',
    component: OttoDecisionTimelineScene,
    description: 'Componente de decisao mostrando pedido, dados consultados, regra aplicada, aprovacao e execucao rastreavel.',
    duration: OTTO_FINANCIAL_SCENE_COMPONENT_DURATION,
    height: 720,
    kind: 'Actions',
    label: 'Otto Decision Timeline',
    tags: ['Otto', 'Financeiro', 'Decisao', 'Auditoria'],
    value: 'actions-otto-decision-timeline',
    width: 1280,
  },
  {
    code: '<OttoExceptionQueueScene />',
    component: OttoExceptionQueueScene,
    description: 'Fila de excecoes para itens financeiros, fiscais e administrativos que exigem atencao humana.',
    duration: OTTO_FINANCIAL_SCENE_COMPONENT_DURATION,
    height: 720,
    kind: 'Actions',
    label: 'Otto Exception Queue',
    tags: ['Otto', 'Financeiro', 'Excecoes', 'Controle'],
    value: 'actions-otto-exception-queue',
    width: 1280,
  },
  {
    code: '<OttoAuditTrailScene />',
    component: OttoAuditTrailScene,
    description: 'Trilha de auditoria com origem, autor, regras aplicadas e acoes executadas pela IA.',
    duration: OTTO_FINANCIAL_SCENE_COMPONENT_DURATION,
    height: 720,
    kind: 'Actions',
    label: 'Otto Audit Trail',
    tags: ['Otto', 'Auditoria', 'Compliance', 'Financeiro'],
    value: 'actions-otto-audit-trail',
    width: 1280,
  },
  {
    code: '<OttoMultiAgentHandoffScene />',
    component: OttoMultiAgentHandoffScene,
    description: 'Handoff visual entre agentes de financeiro, fiscal, cobranca e relatorios.',
    duration: OTTO_FINANCIAL_SCENE_COMPONENT_DURATION,
    height: 720,
    kind: 'Actions',
    label: 'Otto Multi-Agent Handoff',
    tags: ['Otto', 'Agentes', 'Handoff', 'Workflow'],
    value: 'actions-otto-multi-agent-handoff',
    width: 1280,
  },
  {
    code: '<OttoAdminInboxZeroScene />',
    component: OttoAdminInboxZeroScene,
    description: 'Cena de inbox administrativo mostrando documentos entrando baguncados e saindo em pastas prontas.',
    duration: OTTO_FINANCIAL_SCENE_COMPONENT_DURATION,
    height: 720,
    kind: 'Actions',
    label: 'Otto Admin Inbox Zero',
    tags: ['Otto', 'Administrativo', 'Documentos', 'Inbox'],
    value: 'actions-otto-admin-inbox-zero',
    width: 1280,
  },
  {
    code: '<OttoMarginLeakInsightScene />',
    component: OttoMarginLeakInsightScene,
    description: 'Insight reveal mostrando vazamentos de margem e principais causas financeiras.',
    duration: OTTO_FINANCIAL_SCENE_COMPONENT_DURATION,
    height: 720,
    kind: 'Actions',
    label: 'Otto Margin Leak Insight',
    tags: ['Otto', 'Insight', 'Margem', 'Financeiro'],
    value: 'actions-otto-margin-leak-insight',
    width: 1280,
  },
  {
  ...
  },
  {
    ...
    description: 'Video mobile do ChatGPT com agentes financeiros para classificacao/conciliacao, relatorio com dashboard e emissao de nota fiscal.',
  ...
  },
  {
    ...
    description: 'Conteúdo-base do ChatGPT criado para monitores, sem a abertura central e com H1 de 220 px.',
    duration: OTTO_INVOICE_CHATGPT_MONITOR_CONTENT_DURATION,
    height: 547,
    kind: 'Vídeos criados',
    label: 'ChatGPT — Base para monitor (sem introdução, H1 220 px)',
    tags: ['ChatGPT', 'Otto', 'Notas Fiscais', 'Monitor', '220px'],
  ...
  {
    code: '<ClaudeFinancialAgentsVideo />',
    component: ClaudeFinancialAgentsVideo,
    description: 'Video mobile do Claude mostrando Otto acionando 7 agentes financeiros com tool use, tabelas, dashboard e insights.',
    duration: CLAUDE_FINANCIAL_AGENTS_VIDEO_DURATION,
    height: 1920,
    kind: 'Vídeos criados',
    label: 'Claude Financial Agents',
  ...
  },
  {
    ...
    description: 'Animacao vertical minimalista de conexao segura e sincronizacao em cascata de contas financeiras.',
  ...
  },
  {
    ...
    description: 'Conversa mobile em que Otto concilia contas, sincroniza dados e depois classifica despesas com tool calls dentro do chat.',
    duration: CHATBOT_SYNC_TOOL_DURATION,
    height: 1920,
    kind: 'Vídeos criados',
    label: 'Chatbot Sync Tool',
    tags: ['Chatbot', 'Sync', 'Despesas', 'Tool Call', 'Financeiro', 'Otto'],
  ...
  },
  {
    ...
    description: 'Animacao vertical minimalista de classificacao automatica de despesas em cascata.',
  ...
  },
  {
    ...
    description: 'Animacao vertical minimalista de conciliacao bancaria com matching em cascata.',
