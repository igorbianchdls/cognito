...
const catalog: CatalogItem[] = [
  ...
  },
  {
    ...
    description: 'Conteúdo-base do ChatGPT criado para monitores, sem a abertura central e com H1 de 200 px.',
    duration: OTTO_INVOICE_CHATGPT_MONITOR_CONTENT_DURATION,
    height: 547,
    kind: 'Vídeos criados',
    label: 'ChatGPT — Base para monitor (sem introdução, H1 200 px)',
    tags: ['ChatGPT', 'Otto', 'Notas Fiscais', 'Monitor', '200px'],
