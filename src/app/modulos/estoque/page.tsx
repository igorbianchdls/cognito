    ...
    switch (tabs.selected) {
      case 'produtos':
        return {
          ...
          data: [
            { sku: 'SKU-001', nome: 'Produto A', estoque: 120, preco: 59.9 },
            { sku: 'SKU-002', nome: 'Produto B', estoque: 42, preco: 119.0 },
          ],
        }
      case 'visao':
      default:
        return {
          ...
          data: [
            { indicador: 'Itens em estoque', valor: 1620 },
            { indicador: 'Itens abaixo do mínimo', valor: 18 },
            { indicador: 'Valor total (R$)', valor: 98540.5 },
          ],
        }
    }
  }, [tabs.selected])
