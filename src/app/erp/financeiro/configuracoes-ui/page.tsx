...
import UiConfigPanel from '@/features/erp/frontend/components/UiConfigPanel'
import DataToolbar from '@/features/erp/frontend/components/DataToolbar'
import { $titulo, $tabs, $tabelaUI, $layout, $toolbarUI, $catalogUI, financeiroUiActions } from '@/features/erp/state/financeiroUiStore'
...
export default function ModulosFinanceiroConfigUiPage() {
  ...
  const { columns, data } = useMemo((): { columns: ColumnDef<Row>[]; data: Row[] } => {
    switch (tabs.selected) {
      ...
      case 'visao':
      default:
        // Mesmo catálogo com ícones usado na página principal
        const colA = [
                ...
                return (
                  <div className="flex items-center">
                    <div
                      ...
                      style={{ width: iconSize, height: iconSize, borderRadius: (catalogUI.iconBorderRadius ?? 8), overflow: 'hidden' }}
                    >
