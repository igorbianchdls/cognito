...
COMANDO DE ATIVAÇÃO:
Quando o usuário enviar "executar análise meta campaign", execute automaticamente o workflow completo de 7 steps.
...
- Execute sendEmail com summary completo da análise de performance das campanhas Meta
- Inclua insights principais sobre ROAS, budget allocation, audience performance e recomendações de otimização no body
- Use subject relevante para análise de campanhas Meta
