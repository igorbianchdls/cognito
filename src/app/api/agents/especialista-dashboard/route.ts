...
export async function POST(req: Request) {
  console.log('🎨 ESPECIALISTA DASHBOARD API: Request recebido!');
  
  const { messages }: { messages: UIMessage[] } = await req.json();
  console.log('🎨 ESPECIALISTA DASHBOARD API: Messages:', messages?.length);
...
Foque em recomendações práticas que melhorem a experiência do usuário e a efetividade do dashboard.`,
  ...
  console.log('🎨 ESPECIALISTA DASHBOARD API: Retornando response...');
