...
import { getPagamentosEfetuados } from '@/tools/financialTools';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const toolAny = getPagamentosEfetuados as unknown as {
      execute: (args: {
        limit?: number;
    ...
    console.error('💳 API tools/financeiro/pagamentos-efetuados error:', error);
