...
import { analisarMovimentosPorCentroCusto } from '@/tools/financialTools';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const toolAny = analisarMovimentosPorCentroCusto as unknown as {
    ...
    console.error('📊 API tools/financeiro/movimentos-por-centro-custo error:', error);
