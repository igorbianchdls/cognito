...
import { analyzeCreativePerformance } from '@/tools/paidTrafficTools';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const toolAny = analyzeCreativePerformance as unknown as {
    ...
    console.error('📊 API paid-traffic/creative-performance error:', error);
