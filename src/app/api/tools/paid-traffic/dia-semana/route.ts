...
import { desempenhoPorDiaDaSemana } from '@/tools/paidTrafficTools';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const toolAny = desempenhoPorDiaDaSemana as unknown as {
    ...
    console.error('📊 API paid-traffic/dia-semana error:', error);
