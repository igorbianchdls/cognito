...
const SALES_TEMPLATE_TEXT = JSON.stringify([
  {
    ...
    children: [
      ...
      { type: "Div", props: { direction: "row", gap: 12, padding: 16, justify: "start", align: "start", childGrow: true }, children: [
        { type: "PieChart", props: { fr: 1, title: "Canais", titleStyle: { fontFamily: "Barlow", fontWeight: 700, fontSize: 16, color: "#0f172a", letterSpacing: "0.02em", textTransform: "uppercase", padding: 8, textAlign: "left" }, containerStyle: { borderWidth: 2, borderColor: "#0ea5e9", borderRadius: 12 }, dataQuery: { model: "vendas.pedidos", dimension: "canal_venda", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 6 }, xKey: "canal_venda", yKey: "faturamento_total", format: "currency", height: 240, nivo: { innerRadius: 0.35, theme: { labels: { text: { fontFamily: "Avenir", fontSize: 12, fill: "#0f172a" } } } } } },
        { type: "BarChart", props: { fr: 2, title: "Categorias", titleStyle: { fontFamily: "Barlow", fontWeight: 600, fontSize: 14, color: "#334155", padding: 6 }, containerStyle: { borderWidth: 2, borderColor: "#10b981", borderStyle: "dashed", borderRadius: 10 }, dataQuery: { model: "vendas.pedidos", dimension: "categoria_receita", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 6 }, xKey: "categoria_receita", yKey: "faturamento_total", format: "currency", height: 240, nivo: { layout: 'horizontal', theme: { axis: { ticks: { text: { fontFamily: "Geist", fontSize: 12, fill: "#334155" } }, legend: { text: { fontFamily: "Geist", fontSize: 12, fill: "#0f172a" } } } } } } },
        { type: "BarChart", props: { fr: 2, title: "Clientes", containerStyle: { borderWidth: 3, borderColor: "#f59e0b", borderStyle: "solid", borderRadius: 6, boxShadow: "none" }, dataQuery: { model: "vendas.pedidos", dimension: "cliente", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 5 }, xKey: "cliente", yKey: "faturamento_total", format: "currency", height: 240, nivo: { layout: 'horizontal', theme: { axis: { ticks: { text: { fontFamily: "Inter", fontSize: 12, fill: "#334155" } }, legend: { text: { fontFamily: "Inter", fontSize: 12, fill: "#0f172a" } } } } } } }
      ]},

      { type: "Div", props: { direction: "row", gap: 12, padding: 16, justify: "start", align: "start", childGrow: true }, children: [
        { type: "BarChart", props: { fr: 1, title: "Vendedores", containerStyle: { borderWidth: 2, borderColor: "#8b5cf6", borderRadius: 10 }, dataQuery: { model: "vendas.pedidos", dimension: "vendedor", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 6 }, xKey: "vendedor", yKey: "faturamento_total", format: "currency", height: 220, nivo: { layout: 'horizontal', theme: { axis: { ticks: { text: { fontFamily: "IBM Plex Mono", fontSize: 11, fill: "#475569" } }, legend: { text: { fontFamily: "IBM Plex Mono", fontSize: 12, fill: "#0f172a" } } } } } } },
        { type: "BarChart", props: { fr: 1, title: "Filiais", containerStyle: { borderWidth: 2, borderColor: "#ef4444", borderStyle: "dotted", borderRadius: 12 }, dataQuery: { model: "vendas.pedidos", dimension: "filial", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 6 }, xKey: "filial", yKey: "faturamento_total", format: "currency", height: 220, nivo: { layout: 'horizontal', theme: { axis: { ticks: { text: { fontFamily: "Libre Baskerville", fontSize: 12, fill: "#334155" } }, legend: { text: { fontFamily: "Libre Baskerville", fontSize: 12, fill: "#0f172a" } } } } } } },
        { type: "BarChart", props: { fr: 1, title: "Unidades de Negócio", containerStyle: { borderWidth: 1, borderColor: "#334155", borderStyle: "solid", borderRadius: 8 }, dataQuery: { model: "vendas.pedidos", dimension: "unidade_negocio", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 6 }, xKey: "unidade_negocio", yKey: "faturamento_total", format: "currency", height: 220, nivo: { layout: 'horizontal', theme: { axis: { ticks: { text: { fontFamily: "Space Mono", fontSize: 12, fill: "#334155" } }, legend: { text: { fontFamily: "Space Mono", fontSize: 12, fill: "#0f172a" } } } } } } }
      ]},

      { type: "Div", props: { direction: "row", gap: 12, padding: 16, justify: "start", align: "start", childGrow: true }, children: [
        { type: "LineChart", props: { fr: 3, title: "Faturamento por Mês", dataQuery: { model: "vendas.pedidos", dimension: "mes", dimensionExpr: "DATE_TRUNC('month', p.data_pedido)::date", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "dimension", dir: "asc" }, limit: 12 }, xKey: "mes", yKey: "faturamento_total", format: "currency", height: 240, nivo: { curve: 'monotoneX', area: true } } }
      ]},

      { type: "Div", props: { direction: "row", gap: 12, padding: 16, justify: "start", align: "start", childGrow: true }, children: [
        { type: "BarChart", props: { fr: 1, title: "Pedidos por Mês", dataQuery: { model: "vendas.pedidos", dimension: "mes", dimensionExpr: "DATE_TRUNC('month', p.data_pedido)::date", measure: "COUNT()", filters: { tenant_id: 1 }, orderBy: { field: "dimension", dir: "asc" }, limit: 12 }, xKey: "mes", yKey: "count", format: "number", height: 220, nivo: { layout: 'vertical' } } },
        { type: "BarChart", props: { fr: 1, title: "Ticket Médio por Mês", dataQuery: { model: "vendas.pedidos", dimension: "mes", dimensionExpr: "DATE_TRUNC('month', p.data_pedido)::date", measure: "AVG(p.valor_total)", filters: { tenant_id: 1 }, orderBy: { field: "dimension", dir: "asc" }, limit: 12 }, xKey: "mes", yKey: "ticket_medio", format: "currency", height: 220, nivo: { layout: 'vertical' } } }
      ]},

      { type: "Div", props: { direction: "row", gap: 12, padding: 16, justify: "start", align: "start", childGrow: true }, children: [
        { type: "BarChart", props: { fr: 1, title: "Territórios", containerStyle: { borderless: false, borderWidth: 2, borderColor: "#0ea5e9" }, dataQuery: { model: "vendas.pedidos", dimension: "territorio", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 6 }, xKey: "territorio", yKey: "faturamento_total", format: "currency", height: 220, nivo: { layout: 'horizontal', theme: { axis: { ticks: { text: { fontFamily: "Geist Mono", fontSize: 12, fill: "#334155" } }, legend: { text: { fontFamily: "Geist Mono", fontSize: 12, fill: "#0f172a" } } } } } } },
        { type: "BarChart", props: { fr: 1, title: "Serviços/Categorias", containerStyle: { borderWidth: 2, borderColor: "#22c55e" }, dataQuery: { model: "vendas.pedidos", dimension: "categoria_receita", measure: "SUM(itens.subtotal)", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 6 }, xKey: "categoria_receita", yKey: "faturamento_total", format: "currency", height: 220, nivo: { layout: 'horizontal', theme: { axis: { ticks: { text: { fontFamily: "EB Garamond", fontSize: 12, fill: "#334155" } }, legend: { text: { fontFamily: "EB Garamond", fontSize: 12, fill: "#0f172a" } } } } } } },
        { type: "BarChart", props: { fr: 1, title: "Pedidos", borderless: true, dataQuery: { model: "vendas.pedidos", dimension: "canal_venda", measure: "COUNT()", filters: { tenant_id: 1 }, orderBy: { field: "measure", dir: "desc" }, limit: 6 }, xKey: "canal_venda", yKey: "count", format: "number", height: 220, nivo: { layout: 'horizontal', theme: { axis: { ticks: { text: { fontFamily: "Avenir", fontSize: 12, fill: "#334155" } }, legend: { text: { fontFamily: "Avenir", fontSize: 12, fill: "#0f172a" } } } } } } }
      ]}
    ]
  }
], null, 2);
