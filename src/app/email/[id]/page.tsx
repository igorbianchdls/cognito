            ...
            <div className="px-2 md:px-3 py-2">
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  <button onClick={() => router.push('/email' + (q?.get('inboxId') ? `?inboxId=${encodeURIComponent(q.get('inboxId') as string)}` : ''))} className="rounded-md border border-gray-200 bg-white px-3 py-1.5 text-xs text-gray-700 hover:bg-gray-50"><ArrowLeft className="mr-1 inline size-3.5" /> Inbox</button>
