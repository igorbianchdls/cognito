              ...
              <div className="p-3">
                <div className="relative">
                  ...
                  <select
                    ...
                    className="h-10 w-full appearance-none rounded-lg border border-neutral-300 bg-white pl-7 pr-8 text-sm font-medium text-neutral-900 outline-none focus:border-neutral-400"
                  >
