...
} from '@/assets/remotion/saas/scenes'
import { resolveSaaSTheme } from '@/assets/remotion/saas/theme'
import type { SaaSIntroScene, SaaSIntroVideoConfig } from '@/assets/remotion/saas/types'
