...
import { FloatingScreenshot } from '@/assets/remotion/saas/frames'
import type { SaaSFeature, SaaSLogo, SaaSMetric, SaaSProductScreen, SaaSTheme } from '@/assets/remotion/saas/types'
