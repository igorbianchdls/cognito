...
const responsiveHeroTitleClassName = '[--otto-title-size:40px] md:[--otto-title-size:48px]'
const responsiveSectionTitleClassName = '[--otto-title-size:40px] md:[--otto-title-size:48px]'
