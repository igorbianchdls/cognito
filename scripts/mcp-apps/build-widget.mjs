...
const webDir = path.join(root, 'src/products/mcp-apps/web')
...
const componentJs = String.raw`(() => {
  ...
  function emptyState(title, description) {
    return '<section class="state-card">' +
      ...
      '<p>' + escapeHtml(description || 'Peca ao MCP host para listar ou abrir um dashboard.') + '</p>' +
    '</section>';
  }
...
console.log('Built MCP Apps widget:')
