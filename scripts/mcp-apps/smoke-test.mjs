...
async function main() {
  ...
  assert(toolsSource.includes('kind=dashboard, slide ou report'), 'artifact_authoring description should mention supported artifact kinds')
  ...
  assert(artifactToolsSource.includes('getPagedArtifactContract'), 'artifact tool should expose paged artifact contracts')
  assert(artifactToolsSource.includes('REPORT_TEMPLATE_SOURCE'), 'artifact tool should expose report example')
  assert(artifactToolsSource.includes('SLIDE_TEMPLATE_SOURCE'), 'artifact tool should expose slide example')
  ...
  assert(artifactSchemasSource.includes("enum: ['dashboard', 'slide', 'report']"), 'artifact authoring kind enum missing')
