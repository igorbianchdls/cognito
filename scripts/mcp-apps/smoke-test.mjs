...
async function main() {
  ...
  assert(domainToolsSource.includes('case MCP_APP_DOMAIN_TOOL_NAMES.dataCatalog'), 'data_catalog dispatch missing')
  ...
  const dataCatalogViewSource = await readFile(path.join(root, 'src/products/mcp-apps/web/src/views/DataCatalogView.tsx'), 'utf8')
  ...
  const analysisViewSource = await readFile(path.join(root, 'src/products/mcp-apps/web/src/views/AnalysisView.tsx'), 'utf8')
  const tableViewSource = await readFile(path.join(root, 'src/products/mcp-apps/web/src/views/TableResultView.tsx'), 'utf8')
  const automationViewSource = await readFile(path.join(root, 'src/products/mcp-apps/web/src/views/AutomationView.tsx'), 'utf8')
  const connectorsViewSource = await readFile(path.join(root, 'src/products/mcp-apps/web/src/views/ConnectorsView.tsx'), 'utf8')
