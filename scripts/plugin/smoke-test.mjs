...
async function main() {
  ...
  assert(connectorsViewSource.includes('connector-card'), 'connectors view cards missing')
  ...
  assert(stylesSource.includes('.connector-card'), 'connectors card style missing')
