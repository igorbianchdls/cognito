...
async function main() {
  ...
  assert(!toolsSource.includes("connectors: 'connectors'"), 'retired connectors tool must not be registered')
  ...
  assert(!toolsSource.includes('function callConnectors'), 'retired connectors dispatcher must be removed')
  ...
  assert(dashboardToolsSource.includes("mode: 'inline', queries_supported: false"), 'dashboard contract must expose inline data without SQL')
  assert(dashboardToolsSource.includes('supported_html_tags'), 'dashboard contract should expose supported HTML tags')
  assert(dashboardToolsSource.includes('id="resumo"'), 'dashboard example should include root Dashboard id')
  assert(!dashboardToolsSource.includes('dataQuery={{'), 'dashboard example must not use a retired data query')
  assert(dashboardToolsSource.includes('value={null}'), 'dashboard example must explicitly show unavailable values')
  assert(dashboardToolsSource.includes('data={[]}'), 'dashboard example must support supplied data arrays')
  ...
  assert(artifactSchemasSource.includes("enum: ['get_contract', 'create', 'patch', 'update_full']"), 'artifact authoring action enum must omit retired query preview')
  ...
  assert(!appSource.includes('ConnectorsView'), 'retired connectors view must not be rendered')
