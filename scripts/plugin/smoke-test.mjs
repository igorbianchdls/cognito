...
async function main() {
  ...
  assert(toolsSource.includes("enum: ['dashboard']"), 'dashboards kind enum should be dashboard-only')
  assert(toolsSource.includes('Use kind=dashboard'), 'dashboards description should mention dashboard kind')
  ...
  assert(toolsSource.includes('Use kind=dashboard; action=get_contract'), 'artifact_authoring description should mention dashboard kind')
  ...
  assert(artifactSchemasSource.includes("enum: ['dashboard']"), 'artifact authoring kind enum should be dashboard-only')
