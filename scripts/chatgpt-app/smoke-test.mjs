...
assert(openDashboardTool?._meta?.['openai/outputTemplate'] === 'ui://widget/dashboard-v4.html', 'open_dashboard missing OpenAI outputTemplate')
assert(openDashboardTool?._meta?.ui?.resourceUri === 'ui://widget/dashboard-v4.html', 'open_dashboard missing MCP Apps ui.resourceUri')
