...
<Frame>
  <img src="file:080cd067-1575-4135-aae8-21a53ee26a51" alt="Composio introduction image" />
</Frame>
...
<CardGroup cols={2}>
<Card title="Programmatic creation" href="/docs/programmatic-auth-configs" icon="fa-light fa-code">
  For managing auth configs across multiple projects, you can create them programmatically via the
  API
</Card>
<Card title="Production white-labeling" href="/docs/custom-auth-configs#white-labeling-the-oauth-consent-screen" icon="fa-light fa-palette">
...
<Frame caption="Connect Link authentication screen">
  <img 
    src="file:26e0bfea-6311-413a-a20b-1a24587370eb" 
